...
namespace queryosity
{
  ...
  public:
    ...
    auto filter(lazy<Col> const &col) const;
    template <typename Col>
    auto weight(lazy<Col> const &col) const;

    template <typename Col>
    auto filter(Col const &col) const;
    template <typename Col>
    auto weight(Col const &col) const;
...
template <typename Action>
auto queryosity::lazy<Action>::nominal() -> lazy &
{
  // this is nominal
  return *this;
}
