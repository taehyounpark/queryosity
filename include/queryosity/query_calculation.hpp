...
template <typename T>
void queryosity::query::calculation<T>::initialize(unsigned int,
                                                   unsigned long long begin,
                                                   unsigned long long end) {}

template <typename T>
void queryosity::query::calculation<T>::fill(column::observable<T> x, double) {
  (void)x.value();
}

template <typename T>
void queryosity::query::calculation<T>::finalize(unsigned int) {}