...
template <typename T> class trivial_column : public ana::column::reader<T> {

public:
  trivial_column(const trivial_data_t &data, const std::string &column_name);
...
trivial_input::trivial_input(trivial_data_t data) : m_data(data) {}
...
trivial_reader::trivial_reader(const trivial_data_t &data) : m_data(data) {}
...
template <typename T>
trivial_column<T>::trivial_column(const trivial_data_t &data,
