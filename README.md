...
The aggregated results of this operation comprises the final output that analyzers would want to extract from the dataset; as such, any logic is open to implementable by the end-user via `ana::counter::logic<Result(Columns...)>`.
```cpp
